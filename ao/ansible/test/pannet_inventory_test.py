...
from pannet.ansible.pannet_inventory import main

import sys

class Pannet_InventoryTest(TestCase):
    @staticmethod
    ...
    @classmethod
    def setUpClass(self):
        admin_credentials           = Pannet_InventoryTest.parse_json("admin_credentials")
        tenant_credentials          = Pannet_InventoryTest.parse_json("tenant_credentials")
        tenant_configuration        = Pannet_InventoryTest.parse_json("tenant")
        user_configuration          = Pannet_InventoryTest.parse_json("user")
        role_configuration          = Pannet_InventoryTest.parse_json("role")
        keypair_configuration       = Pannet_InventoryTest.parse_json("keypair")
        network_configuration       = Pannet_InventoryTest.parse_json("network")
        server_configuration        = Pannet_InventoryTest.parse_json("server")
        securitygroup_configuration = Pannet_InventoryTest.parse_json("securitygroup")
        volume_configuration        = Pannet_InventoryTest.parse_json("volume")
        port_configuration          = Pannet_InventoryTest.parse_json("port")
    ...
    @mark.ansible
    @mark.pannet_inventory
    def test__01__inventory(self):
        # prepare
        args     = Pannet_InventoryTest.fixture("pannet_inventory")
        sys.argv = ["", args]
